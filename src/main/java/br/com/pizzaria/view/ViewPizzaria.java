		...
		public void actionPerformed(ActionEvent e) {
			...
			try {
				...
				if (linhaSelecionada < 0) {
					JOptionPane.showMessageDialog(botaoMediaDiaria, "Nenhum item foi adicionado na comanda");
					return;
				}
	...
	private class ActionMaisConsumido implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			...
			try {
				...
				if (linhaSelecionada < 0) {
					JOptionPane.showMessageDialog(botaoMaisConsumido, "Nenhum item foi adicionado na comanda");
					return;
				}
